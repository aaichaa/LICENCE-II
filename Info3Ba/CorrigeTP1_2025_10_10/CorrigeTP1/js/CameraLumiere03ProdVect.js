 function cameraLumiere(scene,camera){   // creation de la camera 
  ...
  var yPos=-1.25;//document.forms["controle"].PosY.value;//*document.forms["controle"].zoom.value;
  var zPos=4.45;//document.forms["controle"].PosZ.value;//*document.forms["controle"].zoom.value;
