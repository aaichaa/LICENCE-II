...
function faceTriangulaire(MaScene,PtA,PtB,PtC,theta,CoulFace){
...
function pyramide(MaScene,theta,coulArete,epai,CoulPt,dimPt){
 ...
 faceTriangle1=faceTriangulaire(MaScene,PtA,PtD,PtP,theta,"#FF0000");
 faceTriangle2=faceTriangulaire(MaScene,PtD,PtC,PtP,theta,"#00FF00");
 faceTriangle3=faceTriangulaire(MaScene,PtC,PtB,PtP,theta,"#0000FF");
 faceTriangle4=faceTriangulaire(MaScene,PtA,PtP,PtB,theta,"#FF0099");
...
function init(){
 ...
 tabloVecteur = pyramide(scene,theta,coulArete,epai,CoulPt,dimPt);
 //********************************************************
 //
 ...
 let v = new THREE.Vector3(G.x-testZero(menuGUI.cameraxPos),G.y-testZero(menuGUI.camerayPos),G.z-testZero(menuGUI.camerazPos));
 vec.normalize();
 let coulVect = "#000000";
