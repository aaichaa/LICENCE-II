 function cameraLumiere(scene,camera){   // creation de la camera 
  ...
  let yPos=4;//document.forms["controle"].PosY.value;//*document.forms["controle"].zoom.value;
  let zPos=1;//document.forms["controle"].PosZ.value;//*document.forms["controle"].zoom.value;
  let xDir=-1;//document.forms["controle"].DirX.value;
  let yDir=0;//document.forms["controle"].DirY.value;
  let zDir=0.25;//testZero(document.forms["controle"].DirZ.value);
...
//scene.add(new THREE.*/
 // add spotlight for the shadows
  ...
  spotConique1.position.set(0, 0, 5);
 ...
 // scene.add(visualisationConeSpot);
  ...
  // affichage du cone de lumiere en "fil de fer"
 // let visualisationConeSpot1 = new THREE.SpotLightHelper(spotConique2);
