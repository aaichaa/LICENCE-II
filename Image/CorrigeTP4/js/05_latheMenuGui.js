...
// fin du plan du sol
 ...
 let ptM1 = tracePt(scene, M1, "#000088",dimPt,true);
 ...
 scene.add(cbeBez1);
 scene.add(cbeBez2);
  let lathe1 = latheBez3(nbPtCB,nbePtRot,P0,P1,P2,P3,"#884400",0.95,false);
  let lathe2 = latheBez3(nbPtCB,nbePtRot,M0,M1,M2,M3,"#008844",0.95,false);
  scene.add(lathe1);
  scene.add(lathe2);
 ...
 guiCoefG1.add(menuGUI,"coefG1",-5,15).onChange(function () {
   vTan2.copy(origine);
   ...
   lathe1 = latheBez3(nbPtCB,nbePtRot,P0,P1,P2,P3,"#884400",0.95,false);
   lathe2 = latheBez3(nbPtCB,nbePtRot,M0,M1,M2,M3,"#008844",0.95,false);
   cbeBez2 = TraceBezierCubique(M0, M1, M2, M3,nbPts,"#0000FF",epaiB);
   ptM1=tracePt(scene, M1, "#000088",dimPt,false);
