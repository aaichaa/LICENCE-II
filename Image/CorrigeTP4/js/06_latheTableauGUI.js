...
// fin du plan du sol
 ...
 let dimPt=0.05;  
 let tabP= new Array(4);   //pts de controle de la premiere courbe
 let tabP1= new Array(3); //pts de controle de la seconde courbe
 ...
 guiCoefG1.add(menuGUI,"coefG1",-10,10).onChange(function () {
   vTan2.copy(origine);
   ...
   lathe2 = latheBezTab(scene,nbPtCB,nbePtRot,tabP1,"#008844",0.95,false);
