...
// tabPtBezCano = BezierCanonique(P0,vectP0,nb,"#FF5555",epai,coulPt,dimPt);
 ...
 tabPtCourbeR=BezierApresRebond(scene,tabPtCourbeQ,nb,"#FF0099",epai,"#000000",dimPt);
 let  cbeBezCourbeR = TraceBezierQuadratique(tabPtCourbeR[0], tabPtCourbeR[1], tabPtCourbeR[2], nbPts,"#005555",2*epai);
 ...
 cbeBezCourbeR = TraceBezierQuadratique(tabPtCourbeR[0], tabPtCourbeR[1], tabPtCourbeR[2], nbPts,"#005555",2*epai);
 for(let k=0;k<2;k++) 
  segment(scene,tabPtCourbeR[k],tabPtCourbeR[k+1],"#FF0000",epai);
 tracePt(scene, tabPtCourbeR[1], "#008888",dimPt,true);
 tracePt(scene, tabPtCourbeR[2], "#008888",dimPt,true);
 ...
 while (tabPtCourbeR[0].distanceTo(tabPtCourbeR[2])>0.25);
